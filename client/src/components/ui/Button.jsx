...
export const Button = ({ title }) => {
  return (
    ...
    <button class="relative group border-none bg-transparent p-0 outline-none cursor-pointer font-pingu  uppercase text-base">
      ...
      <div class="relative flex items-center justify-between py-3 px-6 text-l sm:text-3xl text-black rounded-lg transform -translate-y-1 bg-gradient-to-r from-yellow-400 to-yellow-300 gap-3 transition duration-[600ms] ease-[cubic-bezier(0.3,0.7,0.4,1)] group-hover:-translate-y-1.5 group-hover:duration-[250ms] group-active:-translate-y-0.5 brightness-100 group-hover:brightness-110">
